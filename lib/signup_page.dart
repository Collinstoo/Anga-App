...
class _SignupPageState extends State<SignupPage> {
  ...
  String phoneNumber = '';
  String type = 'User'; // Default user type

  List<String> types = ['User', 'Manager']; // Add more types if needed

  Future<void> registerUser(String name, String username, String email, String password, String phoneNumber, String address, String type) async {
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    //   decoration: InputDecoration(
                    //     labelText: 'Type',
                    //     prefixIcon: Icon(Icons.person_add_alt_1, color: Color(0xFF800000)),
                    //     border: OutlineInputBorder(
                    //       borderRadius: BorderRadius.circular(10.0),
                    //     ),
                    //   ),
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          await registerUser(name, username, email, password, phone, address, type);
                        }
                      },
